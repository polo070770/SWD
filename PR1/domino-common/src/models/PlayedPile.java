...
public class PlayedPile extends Catalog {
	...
	/**
	 * Returns if the specified piece matches with the pieces on the right side
	 * of the pile
	 * 
	 * @param piece
	 * @return
	...
	/**
	 * Returns if the specified piece matches with the pieces on the left side
	 * of the pile
	 * 
	 * @param piece
	 * @return
	...
	/**
	 * Returns if the specified piece matches with the pieces on the specified
	 * side of the pile
	 * 
	 * @param piece
	 * @return
