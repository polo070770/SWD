...
public class Pile extends Catalog {
	...
	/**
	 * Deletes the specified piece from the pile I searches the piece and
	 * compares his values using isEqual method
	 * 
	 * @param piece
	 */
	...
	public Piece getRandomOne() throws PileException {
		...
		for (Iterator<Piece> it = this.pieces.iterator(); it.hasNext(); randomNumber--) {
			...
			if (randomNumber == 0) {
				...
				// removemos el contenido del iterador eliminando asi la pieza
				// de la pila
				it.remove();
				// salimos
				break;
